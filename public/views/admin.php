...
<section class="card">
  <h2>Traduire une phrase manquante</h2>
  <p>Cliquez pour exécuter une traduction automatique via Google Translate.</p>
  <button id="btn-translate-one" class="button primary">🌐 Traduire</button>
  <pre id="output-translate" class="info" style="white-space: pre-wrap; margin-top: 12px;"></pre>
</section>
